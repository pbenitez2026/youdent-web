          ...
          <div className="relative min-h-[500px] overflow-hidden rounded-[2.5rem] shadow-2xl shadow-gray-200">
            ...
            {currentTeamInfo && (
              ...
              >
                ...
                <p
                  className="text-[1.7rem] font-[650] leading-[0.94] tracking-[-0.035em] text-[#102A5E] md:text-[2.65rem]"
                  style={{
                ...
                <p className="mt-4 max-w-[245px] text-[0.82rem] font-normal leading-[1.45] tracking-[-0.005em] text-[#102A5E]/70 md:text-[0.92rem]">
                  {currentTeamInfo.description}
                </p>

                <p
                  className="mt-4 text-[0.78rem] font-medium italic tracking-[0.01em] text-[#6B35A8]/72 md:text-[0.84rem]"
                  style={{
            ...
            >
              <p className="mb-5 text-xs font-black uppercase tracking-[0.22em] text-white/70 md:text-center">
